...
const SearchBlog = ({
  match,
  post: { searchedPosts, loadingSearchedPosts },
}) => {
  return (
    <Fragment>
      <TitleHeader title="Search Results" pageTitle="Blog" />
      <div className="content-wrapper pt-50 pb-20">
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-sm-8 col-md-9 mb-30">
              <div className="blog-wrapper">
                {loadingSearchedPosts && searchedPosts.length <= 0 ? (
                  <Spinner1 />
                ) : !loadingSearchedPosts && searchedPosts.length === 0 ? (
...
export default connect(mapStateToProps, null)(SearchBlog);
